        ...
        <div className="navbar" style={{ backgroundColor: navbarBackground }}>
            ...
            <div className="header-nav">
                <ul className="header-items text-selection-none">
                    <li className={highlight === page.OVERVIEW ? 'highlight' : null}><Link to="overview" smooth={true} duration={animations.SCROLL_SPEED}>Home</Link></li>
                    <li className={highlight === page.ABOUT ? 'highlight' : null}><Link to="about" smooth={true} duration={animations.SCROLL_SPEED}>About</Link></li>
                    <li className={highlight === page.PROJECTS ? 'highlight' : null}><Link to="projects" smooth={true} duration={animations.SCROLL_SPEED}>Projects</Link></li>
                    <li className={highlight === page.SKILLS ? 'highlight' : null}><Link to="skills" smooth={true} duration={animations.SCROLL_SPEED}>Skills</Link></li>
                </ul>
            </div >
        </div >
    )
